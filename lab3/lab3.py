...
ob1_1 = rysuj_pasy_pionowe_szare(480, 320, 10, 60)
ob1_2 = rysuj_ramke_przemiennie_szare(480, 320, 10, 60)
...
obraz2ramka = rysuj_ramke_przemiennie_kolor(480, 320, 10, [64, 0, 128], 32)
obraz2pasy = rysuj_pasy_pionowe_kolor(480, 320, 10, [64, 0, 128], 32)
obraz2ramkaN = negatyw_kolor(obraz2ramka)
obraz2pasyN = negatyw_kolor(obraz2pasy)
obraz2pasy.save("obraz2.png")
obraz2ramka.save("obraz2.jpg")
obraz2pasyN.save("obraz2N.png")
obraz2ramkaN.save("obraz2N.jpg")
...
obraz3 = koloruj_inicjaly(inicjaly, [128, 0, 128], 64)
